...
import InputDataV2 as Settings
...
def draw_survival_curves_and_histograms(simOutputs_NONE, simOutputs_ANTICOAG):
    ...
    :param simOutputs_ANTICOAG: output of a cohort simulated under coagulation therapy
    """
...
def print_comparative_outcomes(simOutputs_NONE, simOutputs_ANTICOAG):
    ...
    under anticoagulation therapy compared to no therapy
    ...
    # increase in survival time under coagulation therapy with respect to no therapy
    ...
    # increase in discounted total cost under anticoagulation therapy with respect to no therapy
    ...
    # increase in discounted total utility under coagulation therapy with respect to no therapy
...
def report_CEA_CBA(simOutputs_NONE, simOutputs_ANTICOAG):
    ...
    CEA = Econ.CEA(
        strategies=[No_therapy_strategy, Anticoagulation_therapy_strategy],
        if_paired=False
        )
    # show the CE plane
    CEA.show_CE_plane(
